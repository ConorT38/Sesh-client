...
$(document).on("click", ".js-msgGroup", function() {
    ...
    $(window).on("resize", function() {
        ...
        content: function() {
            ...
            return '<ul class="nav nav-pills nav-stacked flex-column" style="width: 120px">' + o.html() + "</ul>"
        }
    ...
    function t() {
        a.off("resize.theme.nav"), a.off("scroll.theme.nav"), n.css({
            position: "",
            left: "",
            top: ""
        })
    ...
    function e() {
        ...
        function t() {
            ...
            return t ? void n.css({
                ...
                top: 40
            }) : ($(n.find("li a")[1]).addClass("active"), n.css({
                position: "",
                left: "",
                top: ""
            }))
